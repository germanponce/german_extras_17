function openerp_pos_models(instance, module){ //module is instance.point_of_sale
    ...
    module.Order = Backbone.Model.extend({
        ...
        getAmountStr: function() {
            ...
            console.log(this.getTotalTaxIncluded())
            var total_amount = this.getTotalTaxIncluded()
            console.log(total_amount)
            var amount_to_text = this.covertirNumLetras(total_amount.toString())
            console.log(amount_to_text)
        ...
        export_for_printing: function(){
            ...
            return {
                ...
                name : this.getName(),
                amount_to_text: this.getAmountStr(),
